                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td width="50%">{{ $siswa->nis }} / {{ $siswa->nama }} / {{$kelas->nama_kelas}}</td>
                        </tr>
                        <tr>
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="d-flex flex-row-reverse bd-highlight pt-5 px-4 ">
                    <tbody>
                        <tr>
                            <td class="text-center h6 pb-2">Dicetak Tanggal <span class="fw-bold d-flex justify-content-center"><ins>{{ $tanggal}}</ins></span></td>
                        </tr>
                        <tr>
                            <td class="text-center pt-1 py-4 h6">Yang Menerima,<span class="row pt-5 py-5 fw-bold mt-5 justify-content-center">{{ $petugas->nama_petugas }}</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
